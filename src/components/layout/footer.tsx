      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-purple-200 leading-relaxed max-w-md">
              From Savings to Sustenance, From Poverty to Progress. Empowering
              families through innovative food security and financial
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start space-x-3 text-purple-200">
                ...
                <p className="hover:text-white transition-colors">
                  Suite C06, Afro Mall, Opposite International Building
                  Materials Mkt Dei-Dei, FCT, Abuja
                </p>
              </div>
            </div>
        ...
        <div className="border-t border-gray-300 mt-8 pt-8">
          <p className="text-gray-100">
            &copy; {new Date().getFullYear()} CityGates Food Bank. All rights
            reserved.
          </p>
        </div>
      </div>

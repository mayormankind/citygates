...
// import { Admin, Branch } from '@/lib/types'; // Updated to use Branch type
...
//         const roleNames = rolesSnapshot.docs.map(doc => doc.id);
//         setRoles(roleNames);
//       } catch (error) {
...
//       // Store admin data in the admins collection
...
//             <Select
//               onValueChange={(value) => register('branch').onChange({ target: { value } })}

...
export default function AddUserModal({ open, onOpenChange, Users }: AddUserModalProps) {
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="w-full flex flex-col space-y-4">
          ...
          <p className="text-gray-500 text-xs">
            After registration, you will be contacted by one of our team members to facilitate your physical onboarding and complete KYC. Please wait to be contacted!
          </p>

...
function OtpForm({ phoneNumber }: { phoneNumber: string }) {
  ...
  return (
    ...
    >
      <div className="space-y-1">
        ...
        />
        {errors.otp && (
          <p className="text-red-500 text-xs mt-90">{errors.otp.message}</p>
        )}
      </div>
      <Button
        type="submit"
  ...
  return (
    <div className="w-full flex h-full min-h-screen bg-gradient-to-r from-[#5B1A68] via-purple-800 to-[#5B1A68] relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#F2C400]/5 rounded-full blur3xl animate-glow"></div>
      </div>
      <div className="m-auto w-full h-full min-h-5/7 bg-white max-w-lg grid rounded-mdവ-90">

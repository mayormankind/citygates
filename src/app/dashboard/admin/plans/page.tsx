...
import { Permission, Plan } from "@/lib/types";
...
// import EditPlanModal from "@/components/modals/edit-plan-modal"; // New modal
...
export default function page() {
  ...
  return (
    <ProtectedRoute requiredPermission="View Plans">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex space-x-2">
            <Button
              ...
              disabled={!hasPermission("Create Plans")}
            >
                ...
                {loading ? (
                  ...
                  filteredPlans.map((plan) => (
                    <TableRow key={plan.id}>
                      ...
                      <TableCell>
                        <Badge
                          className={`capitalize ${plan.status === "active" ? "bg-green-100 text-green-800" : plan.status === "inactive" ? "bg-yellow-100 text-yellow-800" : "bg-gray-100 text-gray-800"}`}
                        >
                          {plan.status}
                        </Badge>
                      </TableCell>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {plan.status === "active" ? (
                            <Button
                              ...
                              title="Pause Plan"
                              onClick={() =>
                                handlePlanStatusChange(plan.id, "inactive")
                              }
                            >
                              <Pause
                            ...
                            <Button
                              ...
                              title="Resume Plan"
                              onClick={() =>
                                handlePlanStatusChange(plan.id, "active")
                              }
                            >
                              <Play

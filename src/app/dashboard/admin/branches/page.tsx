...
import { Branch, Permission } from "@/lib/types";
import {
  collection,
  doc,
  onSnapshot,
...
export default function Branches() {
  ...
  const handleBranchStatusChange = async (
    branchId: string,
  ...
  return (
    <ProtectedRoute requiredPermission="View Branches">
      <div className="flex flex-col gap-8 p-4 md:px-8">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 m-0">
              Manage your subscription branches
            </p>
          </div>
        ...
        {showAddModal && (
          <AddBranchModal open={showAddModal} onOpenChange={setShowAddModal} />
        )}
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  ...
                  {selectedBranch.name}"? This action cannot be undone.
                </DialogDescription>
              </DialogHeader>
              <DialogFooter>
                <Button

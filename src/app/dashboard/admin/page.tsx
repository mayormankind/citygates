...
//   const [showKycModal, setShowKycModal] = useState(false); // State for KYC modal
...
//     setSelectedUser(null); // Clear selected user after KYC update
//     setShowKycModal(false); // Close modal
//   };
...
// import ActivateUserModal from "@/components/modals/activate-user-modal"; // New modal
// import ManageAdminsModal from "@/components/modals/manage-admins-modal"; // New modal
  ...
  const handleActivateUser = (userId: string) => {
    ...
    if (userToActivate) {
      if (userToActivate.admins === 0 || !userToActivate.admins) {
        ...
        // Optionally guide to manage admins
